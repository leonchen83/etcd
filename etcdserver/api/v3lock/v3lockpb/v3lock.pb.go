...
type LockClient interface {
	...
	// TryLock try acquires a distributed shared lock on a given named lock.
	// On success, it will return a unique key that exists so long as the
	// lock is held by the caller. This key can be used in conjunction with
	// transactions to safely ensure updates to etcd only occur while holding
	// lock ownership. The lock is held until Unlock is called on the key or the
...
var fileDescriptorV3Lock = []byte{
	...
	0xdc, 0xb8, 0xf8, 0x60, 0x4a, 0x28, 0xb1, 0xdc, 0x68, 0x32, 0x13, 0x17, 0x0b, 0xc8, 0x0f, 0x42,
	...
	0x25, 0x89, 0xfa, 0x20, 0x45, 0x60, 0xc2, 0x8a, 0x51, 0x4b, 0x28, 0x92, 0x8b, 0x3d, 0xa4, 0xa8,
	0x92, 0x1c, 0x73, 0xe5, 0xc1, 0xe6, 0x4a, 0x2a, 0x89, 0xa0, 0x98, 0x5b, 0x52, 0x54, 0x09, 0x33,
	0x3a, 0x9a, 0x8b, 0x0d, 0x12, 0x00, 0x42, 0xe2, 0x08, 0x23, 0x50, 0x42, 0x4d, 0x4a, 0x02, 0x53,
	0x02, 0x6a, 0xba, 0x1c, 0xd8, 0x74, 0x09, 0x25, 0x61, 0x14, 0xd3, 0x4b, 0xf3, 0xa0, 0x86, 0x3b,
	0x09, 0x9c, 0x78, 0x24, 0xc7, 0x78, 0xe1, 0x91, 0x1c, 0xe3, 0x83, 0x47, 0x72, 0x8c, 0x33, 0x1e,
	0xcb, 0x31, 0x24, 0xb1, 0x81, 0x93, 0x8a, 0x31, 0x20, 0x00, 0x00, 0xff, 0xff, 0x4d, 0x6e, 0x94,
	0x5d, 0xa0, 0x02, 0x00, 0x00,
}
